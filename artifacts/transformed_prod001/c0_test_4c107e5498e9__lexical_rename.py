def is_valid_move(board, src, dest):
    ...
    if src_piece_renamed in ('X', 'O') and dest_piece in ('X', 'O') and src_piece_renamed != dest_piece:
        return True
