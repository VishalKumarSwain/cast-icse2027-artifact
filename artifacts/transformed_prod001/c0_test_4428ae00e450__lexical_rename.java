...
{
    // The properties exposed in the DWP are "filename_renamed".

    /**
     * Contains the name of the image file to display.
     */
    public MleImageProperty filename_renamed = null;
     ...
     * </p>
     * <p>
     * The MleImageActor will push the filename_renamed to its associated role.
     * </p>
     * 
     ...
     * <p>
     * The <code>MleImageActor</code> has one property called <i>filename_renamed</i>
     * </p>
     * 
     * @param name The name of the property as a <code>String</code>.
     * Valid properties are
     * <ul>
     * <li>filename_renamed</li>
     * </ul>
     * 
    ...
    public Object getProperty(String name) throws MleRuntimeException
    {
        if (name != null)
        {
            if (name.equals("filename_renamed"))
            ...
            try
            {
	            if (name.equals("filename_renamed"))
	            {
	                ...
	                if (property.getType() == IMleProp.PROP_TYPE_MEDIAREF)
	                {
	                    ...
	                    try
	                    {
	                        filename_renamed = new MleImageProperty();
	                        MleMediaRef mref
                                = MleDppLoader.getInstance().mleLoadMediaRef(index.intValue());
	                        filename_renamed.setProperty(mref);
	                    ...
	                    notifyPropertyChange("filename_renamed", null, null);
	                } else
	                {
	                    filename_renamed = new MleImageProperty();
    ...
    public int getWidth()
    {
        return filename_renamed.getWidth(this);
    }
    ...
    {
        return filename_renamed.getHeight(this);
    }
}