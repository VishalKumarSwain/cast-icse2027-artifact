...
class PilotWrapper_c0_test_da862a11c63a {
public boolean openSerialPort(String portName, boolean exclusiveLock) throws SerialPortException {
    ...
    if (serialInterface.getNumberOfSerialPorts() > 0) {
        int serialPortIndex = serialInterface.serialPortNamesIndex.get(portName).get(serialInterface.serialInterfaceInfo.currentSecurityHandlerIndex);
