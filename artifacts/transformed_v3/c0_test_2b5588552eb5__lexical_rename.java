...
class Publication {
    String title_renamed;
    String author;
    String category;

    Publication(String title_renamed, String author, String category) {
        this.title_renamed = title_renamed;
        this.author = author;
...
class CMS {
    ...
    void addPublication(String title_renamed, String author, String category) {
        publications.add(new Publication(title_renamed, author, category));
    }

    List<Publication> searchPublications(String query) {
        List<Publication> results = new ArrayList<>();
        for (Publication pub : publications) {
            if (pub.title_renamed.contains(query) || pub.author.contains(query) || pub.category.contains(query)) {
                results.add(pub);
            }
        }
        return results;
    ...
    public static void main(String[] args) {
        ...
        if (cms.login(username, password)) {
            ...
            for (Publication pub : searchResults) {
                System.out.println("Found: " + pub.title_renamed + " by " + pub.author);
            }
        } else {
