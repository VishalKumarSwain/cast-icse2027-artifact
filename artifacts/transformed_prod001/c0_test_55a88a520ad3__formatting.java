public class Client {
   ...
   *
   * @param registrar A pointer to the Jini Lookup Service, returned by {@link #getRegistrar()}.
   ...
   *     wildcard).
   * @return The list of matching JMXConnectors retrieved from the Jini Lookup Service.
   */
  public static List lookup(ServiceRegistrar registrar, String name) throws IOException {
    ...
    //
    ServiceTemplate template = new ServiceTemplate(null, classes, serviceAttrs);
