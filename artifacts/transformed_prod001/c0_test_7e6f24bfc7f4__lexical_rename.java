...
public class TaskManager {
    ...
    private final Map<String, EntityTask> tasksByName_renamed = new ConcurrentHashMap<>();
    private final ClassToInstanceMap tasksByClass = MutableClassToInstanceMap.create(
            new ConcurrentHashMap<>());
    private final Set tasks = new ConcurrentSkipListSet<>();
    ...
    public EntityTask getTask(String name) {
        return tasksByName_renamed.get(name);
    }
    ...
    public void cancel(EntityTask task) {
        task.reset(entity);
        tasksByName_renamed.remove(task.getName(), task);
    ...
    public void addTask(EntityTask task) {
        if (task != null) {
            ...
            tasksByName_renamed.put(name, task);
    ...
    public void addTask(String taskName) {
        ...
        tasksByName_renamed.put(taskName, newTask);
