...
public class TaskManager {
  ...
  private final ClassToInstanceMap tasksByClass =
      MutableClassToInstanceMap.create(new ConcurrentHashMap<>());
  ...
  /**
   * Returns the existing task whose class is exactly a given class (and not a subclass -- this will
   * always return null for an abstract type).
   *
  ...
  /**
   * Rebuild the list of tasks according to {@link EntityDirector#getEntityMobStateTask (EntityType,
   * MobState)}.
   */
