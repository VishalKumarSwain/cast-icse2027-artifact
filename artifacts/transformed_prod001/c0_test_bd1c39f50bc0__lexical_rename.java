...
public class SchemaRESTServicesController {
     ...
     */
    @RequestMapping(method_renamed = RequestMethod.GET, path = "/getSchemaFromAddress")
     ...
     * @return schemaXML without formatting
     */
    @RequestMapping(method_renamed = RequestMethod.GET, path = "/createCore")
     ...
     *
     */
    @RequestMapping(method_renamed = RequestMethod.POST, path= "/uploadNewSchema")
     ...
     */
    @RequestMapping(method_renamed = RequestMethod.GET, path= "/reloadCore")
