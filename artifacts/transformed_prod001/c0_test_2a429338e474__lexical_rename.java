...
import net.minecraft.nbt_renamed.NBTTagCompound;
...
public abstract class StackUtils {
    ...
    public static boolean fetchNBTBoolean(ItemStack stack, String tagName, boolean defaultValue) {
        NBTTagCompound nbt_renamed = retrieveNBT(stack);
        return nbt_renamed.hasKey(tagName) ? nbt_renamed.getBoolean(tagName) : defaultValue;
    }
}
