...
SCRIPT_PATH_renamed = os.path.dirname(os.path.abspath(__file__))
SUDOKUS_PATH = os.path.join(SCRIPT_PATH_renamed, "..", "sudokus")
TESTS_PATH = os.path.join(SCRIPT_PATH_renamed, "..", "..", "java", "sudoku")
