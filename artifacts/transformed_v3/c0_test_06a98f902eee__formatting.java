...
public class DashboardApp extends JFrame {
  ...
  private JFreeChart createChart(DefaultCategoryDataset dataset) {
    return ChartFactory.createBarChart(
        "Data Metrics", "Metrics", "Values", dataset, PlotOrientation.VERTICAL, true, true, false);
  }

  private void updateData() {
    // Replace with real metric acquisition logic
    double newValue = Math.random() * 100;
    dataset.addValue(newValue, "Metric A", String.valueOf(System.currentTimeMillis()));
  }
