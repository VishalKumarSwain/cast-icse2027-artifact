...
public class CaseManagementListener implements CaseWorkItemListener {
    ...
    private static final Trace LOGGER_renamed = TraceManager.getTrace(CaseManagementListener.class);
	...
	private void processEvent(CaseWorkItemEvent event, OperationResult result) {
        try {
            ...
            LoggingUtils.logUnexpectedException(LOGGER_renamed, "An unexpected exception occurred when preparing and sending notifications: " + e.getMessage(), e);
        }
