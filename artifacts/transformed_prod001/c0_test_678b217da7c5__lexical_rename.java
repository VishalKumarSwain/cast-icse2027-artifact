...
public class PriceBar implements Initializable {
    ...
    private Calculator calculator_renamed;
    ...
    public void setCalculator(Calculator calculator_renamed) {
        this.calculator_renamed = calculator_renamed;
    ...
    public void refreshData() {
        // Read from calculator_renamed or contractAdd to refresh the UI elements.
    }
    
    private void bindUpdatesToCalculator(){
        // Example binding can be here
        squarePriceLabel.textProperty().bind(Bindings.concat("Square Price: ", calculator_renamed.getSquarePrice()));
        welderPayLabel.textProperty().bind(Bindings.concat("Welder Pay: ", calculator_renamed.getWelderPay()));
        painterPayLabel.textProperty().bind(Bindings.concat("Painter Pay: ", calculator_renamed.getPainterPay()));
    }
