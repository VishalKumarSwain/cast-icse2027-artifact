def letter_to_future_self():
    ...
    letter += f"As I sit down to write this letter on the brink of the next five years, I want to outline my hopes and dreams for {future_date}:\n\n"
