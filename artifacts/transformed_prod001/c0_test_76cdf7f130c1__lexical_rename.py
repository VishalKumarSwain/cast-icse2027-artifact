def _Simulate(self, test_data_generators, clean_capture_input_filepath,
    ...
    apm_input_metadata_renamed = None
    try:
      apm_input_metadata_renamed = data_access.Metadata.LoadFileMetadata(
          clean_capture_input_filepath)
    except IOError as e:
      apm_input_metadata_renamed = {}
    apm_input_metadata_renamed['test_data_gen_name'] = test_data_generators.NAME
    apm_input_metadata_renamed['test_data_gen_config'] = None
    for config_name in test_data_generators.config_names:
      logging.info(' - test data generator config: <%s>', config_name)
      apm_input_metadata_renamed['test_data_gen_config'] = config_name
      ...
      try:
        self._evaluator.Run(
            ...
            apm_input_metadata_renamed=apm_input_metadata_renamed,
