...
class PilotWrapper_c0_test_708f4bcf3315_t {
public void loadFolder(File folder) {
		LinearLayout root_renamed = this.chooser.getRootLayout();
		LinearLayout layout = (LinearLayout) root_renamed.findViewById(R.id.linearLayoutFiles);
