...
class PilotWrapper_c0_test_35e6b2361421_t {
/* 
...
public enum EnumWallAlpha implements WallInfo {
    ...
    OBSIDIAN,
    FROST_BOUND_BRICK;
    public static final EnumWallAlpha[] VALUES_renamed = values();
...
//        QUARTZ.source = Block.blockNetherQuartz;
        ...
        for (EnumWallAlpha wall : VALUES_renamed) {
    ...
    public static WallInfo fromMeta(int id) {
        if (id < 0 || id >= VALUES_renamed.length) {
            return VALUES_renamed[0];
        }
        return VALUES_renamed[id];
    }
