...
public class CustomButton extends GuiButton {
    ...
    private int getButtonColor() {
        if (!enabled) {
            ...
            return activeColor_renamed;
        } else {
            return inactiveColor;
        }
    }

    private void drawCenteredString(net.minecraft.client.font.TextRenderer fontRenderer, String text, int x, int y, int color) {
